...
output_folder = Path('Research/Finance/Stock_Returns/Krauss/results/lstm/lag_60_sector/h_25_l_1_lr_0.001_D3')
...
def create_metric_df(CSV_files, results_folder):
    for K in K_list:
        ...
        print(f"\nSaved global metrics for {len(CSV_files)} years to metrics_k{K}.csv")
